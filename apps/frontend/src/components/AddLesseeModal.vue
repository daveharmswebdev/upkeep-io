        ...
        <div class="flex items-start">
          ...
          <div>
            ...
            <p class="text-sm text-gray-700 dark:text-gray-300">
              Adding a lessee will void the current lease and create a new one with all existing lessees plus the new lessee.
      ...
      <form @submit="onSubmit">
        ...
        <div class="mb-6">
          ...
          <textarea
            ...
            @input="handleInput"
            @blur="handleBlur"
            placeholder="e.g., Adding roommate to lease agreement"
            rows="2"
        ...
        <div class="mb-6">
          ...
          <div class="space-y-4">
            ...
            <FormInput
              name="newLessee.middleName"
              label="Middle Name (Optional)"
              placeholder="M"
            />

            <FormInput
              name="newLessee.email"
              label="Email"
              type="email"
        ...
        <div class="flex gap-4 justify-end">
          ...
          >
            {{ isSubmitting ? 'Adding...' : 'Add Lessee' }}
          </button>
        </div>
      </form>
    </div>
...
import { addLesseeSchema, type AddLesseeInput } from '@validators/lease/addLessee';
...
const submit = async (formValues: any) => {
  ...
  try {
    emit('confirm', formValues as AddLesseeInput);
  } catch (error: any) {
